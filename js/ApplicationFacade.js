...
},
{
    ...
    editNote: function(productID) {
        this.sendNotification(ApplicationFacade.EDIT_NOTE, productID);
    },

    deleteNote: function(productID) {
        this.sendNotification(ApplicationFacade.DELETE_NOTE, productID);
    }
